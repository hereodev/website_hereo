...
export default function VidPlayer({ videoSrc = "https://hereotherwise.b-cdn.net/assets_website/intro_EN.mp4", cn, ctrls=false } : { videoSrc?: string, cn?: string, ctrls?: boolean }) {
